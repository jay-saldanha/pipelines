...
| Name | Description |
|-------------|-----------------------------------------------------|
| job_id | The ID of the batch prediction job that is created. |
| output_path | The output path of the batch prediction job. |
...
*   [Cloud ML Engine REST API](https://cloud.google.com/ml-engine/reference/rest/v1/projects.jobs)
